...
PROGRESS_DOWNLOAD_START = 10  # Pourcentage de progression au début du téléchargement
PROGRESS_EXTRACTION_START = 60  # Pourcentage de progression au début de l'extraction
DENO_VERSION_CHECK_TIMEOUT = 10  # Délai d'attente en secondes pour la vérification de version
    ...
    def download_deno(self, progress_callback=None) -> bool:
        ...
        try:
            if progress_callback:
                progress_callback(PROGRESS_DOWNLOAD_START, "Téléchargement de deno...")
            else:
            ...
            if progress_callback:
                progress_callback(PROGRESS_EXTRACTION_START, "Extraction de deno...")
            else:
    ...
    def verify_deno(self) -> Tuple[bool, str]:
        ...
        try:
            result = subprocess.run(
                ...
                capture_output=True,
                text=True,
                timeout=DENO_VERSION_CHECK_TIMEOUT
            )
