...
DEFAULT_REACTIVITY = 0.15
DEFAULT_DEAD_ZONE = 0.15
PODCAST_REACTIVITY = 0.08
PODCAST_DEAD_ZONE = 0.20
INTERVIEW_REACTIVITY = 0.12
...
class TrackingConfig:
    ...
    reactivity: float = DEFAULT_REACTIVITY
...
PRESET_CONFIGS: Dict[TrackingPreset, TrackingConfig] = {
    TrackingPreset.PODCAST: TrackingConfig(
        reactivity=PODCAST_REACTIVITY,
        max_velocity=0.3,
        dead_zone=PODCAST_DEAD_ZONE,
        face_priority=1.0,
        sample_rate=4,
        multi_subject_mode="largest"
    ),
    TrackingPreset.INTERVIEW: TrackingConfig(
        reactivity=INTERVIEW_REACTIVITY,
        max_velocity=0.6,
        dead_zone=0.15,
        face_priority=1.0,
        sample_rate=5,
