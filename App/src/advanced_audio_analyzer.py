...
# Constantes de configuration audio
DEFAULT_SAMPLE_RATE: int = 22050
DEFAULT_HOP_LENGTH: int = 512
QUICK_MODE_SAMPLE_RATE: int = 11025
QUICK_MODE_HOP_LENGTH: int = 1024
QUICK_MODE_EMOTION_WINDOW: float = 10.0
MAX_SAMPLE_DURATION: float = 180.0
...
class AdvancedAudioAnalyzer:
    ...
    def __init__(
        ...
        if quick_mode:
            ...
            self.sample_rate = QUICK_MODE_SAMPLE_RATE
            self.hop_length = QUICK_MODE_HOP_LENGTH
            self.emotion_window = QUICK_MODE_EMOTION_WINDOW
        else:
    ...
    def analyze_sample(
        self,
        audio_path: str,
        max_duration: float = MAX_SAMPLE_DURATION,
