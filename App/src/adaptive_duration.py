...
PLATFORM_MIN_DURATION: float = 15.0
TIKTOK_MAX_DURATION: float = 60.0
TIKTOK_IDEAL_DURATION: float = 30.0
TIKTOK_MAX_FILE_SIZE_MB: int = 287
REELS_MAX_DURATION: float = 90.0
REELS_IDEAL_DURATION: float = 60.0
REELS_MAX_FILE_SIZE_MB: int = 250
SHORTS_MAX_DURATION: float = 60.0
SHORTS_IDEAL_DURATION: float = 45.0
SHORTS_MAX_FILE_SIZE_MB: int = 500
VERTICAL_ASPECT_RATIO: Tuple[int, int] = (9, 16)
...
PLATFORM_SPECS = {
    Platform.TIKTOK: PlatformSpec(
        name="TikTok",
        min_duration=PLATFORM_MIN_DURATION,
        max_duration=TIKTOK_MAX_DURATION,
        ideal_duration=TIKTOK_IDEAL_DURATION,
        aspect_ratio=VERTICAL_ASPECT_RATIO,
        max_file_size_mb=TIKTOK_MAX_FILE_SIZE_MB
    ),
    Platform.REELS: PlatformSpec(
        name="Instagram Reels",
        min_duration=PLATFORM_MIN_DURATION,
        max_duration=REELS_MAX_DURATION,
        ideal_duration=REELS_IDEAL_DURATION,
        aspect_ratio=VERTICAL_ASPECT_RATIO,
        max_file_size_mb=REELS_MAX_FILE_SIZE_MB
    ),
    Platform.SHORTS: PlatformSpec(
        name="YouTube Shorts",
        min_duration=PLATFORM_MIN_DURATION,
        max_duration=SHORTS_MAX_DURATION,
        ideal_duration=SHORTS_IDEAL_DURATION,
        aspect_ratio=VERTICAL_ASPECT_RATIO,
        max_file_size_mb=SHORTS_MAX_FILE_SIZE_MB
    ),
}
