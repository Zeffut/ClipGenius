...
class TestConfig:
    ...
    start_time: float = DEFAULT_START_TIME     # Début du segment (secondes)
    duration: float = DEFAULT_CLIP_DURATION    # Durée du clip test
...
def main():
    ...
    parser.add_argument("--start", type=float, default=DEFAULT_START_TIME, help="Temps de début (secondes)")
    parser.add_argument("--duration", type=float, default=DEFAULT_CLIP_DURATION, help="Durée du clip test")
